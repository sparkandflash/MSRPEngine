...
*   **Asynchronous Proactive Texting:** Engine autonomously initiates conversations asynchronously, bypassing the rigid request/response cycle.
---
...
## Roadmap: Classification - Structures vs Behaviours
* **Structures to implement:**
  * Pattern completion instinct
  * Model making (candidate models)
* **Behaviours to obtain from structures:**
  * Asking questions (generated by the pattern completion instinct while traversing context during idle methods)
